...
namespace AlemanGroupServices.API.Controllers
{
    ...
    public class TblcompaniesofproductsController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<CompanyOfProductDto>> GetWithProductNameAndSourceComapnyName()
        {
            ...
            var query =
                ...
                select new CompanyOfProductDto 
                {
                    ...
                    Source_Company_Name = marketingCompaniesTbl.Marketing_comany
                };
        ...
        public ActionResult<Tblcompaniesofproduct> GetTblcompaniesofproduct(int product_id, int source_company_id)
        {
          if (_context.Tblcompaniesofproducts == null)
          {
              return NotFound();
        ...
        public ActionResult<CompanyOfProductDto> GetTblcompaniesofproductWithNames(string product_name, string source_company_name)
        {
            ...
            var source_compnay = _context.Tblmarketingcompnies.Where(m=> m.Marketing_comany == source_company_name).FirstOrDefault();
            ...
            return new CompanyOfProductDto { Date = tblcompaniesofproduct.Date, Product_Name = product.Product_Name, Source_Company_Name = source_compnay.Marketing_comany};
        }
        ...
        public ActionResult<IEnumerable<CompanyOfProductDto>> Get_product_sources(string product_name)
        {
            ...
            var tblcompaniesofproduct = _context.Tblcompaniesofproducts
                ...
                (source_company, marketing_company) =>new CompanyOfProductDto 
                {
                    ...
                    Source_Company_Name = marketing_company.Marketing_comany
                }
                ).ToList();
        ...
        public async Task<IActionResult> PutTblcompaniesofproduct(int product_id, int source_company_id , Tblcompaniesofproduct tblcompaniesofproduct)
        {
        ...
        public async Task<IActionResult> PutTblcompaniesofproductDto(string product_name, string source_company_name, CompanyOfProductDto companyOfProductDto)
        {
            ...
            var source_compnay = await _context.Tblmarketingcompnies.Where(m => m.Marketing_comany == companyOfProductDto.Source_Company_Name).FirstOrDefaultAsync();
            if (source_compnay == null)
            {
        ...
        public async Task<ActionResult<Tblcompaniesofproduct>> PostCompaniesOfProductDto(CompanyOfProductDto tblcompaniesofproductDto)
        {
            ...
            var source_compnay = await _context.Tblmarketingcompnies.Where(m => m.Marketing_comany == tblcompaniesofproductDto.Source_Company_Name).FirstOrDefaultAsync();
            if (source_compnay == null)
            {
        ...
        public async Task<IActionResult> DeleteTblcompaniesofproduct(int product_id, int source_company_id)
        {
            if (_context.Tblcompaniesofproducts == null)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteTblcompaniesofproductDto(string product_name, string source_company_name)
        {
            ...
            var source_compnay = await _context.Tblmarketingcompnies.Where(m => m.Marketing_comany == source_company_name).FirstOrDefaultAsync();
            if (source_compnay == null)
            {
                return NotFound($" there is no Marketing company wiht name '{source_company_name}'");
            }
        ...
        private bool TblcompaniesofproductExists(int product_id, int source_company_id)
        {
